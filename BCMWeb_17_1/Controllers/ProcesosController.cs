        ...
        public ActionResult EditIfUpdatePartial(ProcesoImpactoModel dataImpacto)
        {
            if (ModelState.IsValid)
            {
                using (Entities db = new Entities())
                {
                    ...
                    {
                        var regs = db.tblBIAImpactoFinanciero.Where(x => x.Impacto == dataImpacto.Impacto).ToList();
            ...
            using (Entities db = new Entities())
            {
                ...
                if (ValoresIF.Count() > 0)
                {
                    foreach (string valor in ValoresIF)
                    {
                        ...
                        string _Descripcion = db.tblEscala.FirstOrDefault(x => x.IdEmpresa == IdEmpresa && x.IdTipoEscala == 1 && x.IdEscala == _valor).Descripcion;
                ...
                if (ValoresIO.Count() > 0)
                {
                    ...
                    {
                        long _valor = long.Parse(valor);
                        string _Descripcion = db.tblEscala.FirstOrDefault(x => x.IdEmpresa == IdEmpresa && x.IdTipoEscala == 2 && x.IdEscala == _valor).Descripcion;
                        tblCriticidad _criticidad = new tblCriticidad
                        {
                            DescripcionEscala = _Descripcion,
                            IdEmpresa = IdEmpresa,
                ...
                if (ValoresMTD.Count() > 0)
                {
                    ...
                    {
                        long _valor = long.Parse(valor);
                        string _Descripcion = db.tblEscala.FirstOrDefault(x => x.IdEmpresa == IdEmpresa && x.IdTipoEscala == 3 && x.IdEscala == _valor).Descripcion;
                        tblCriticidad _criticidad = new tblCriticidad
                        {
                            DescripcionEscala = _Descripcion,
                            IdEmpresa = IdEmpresa,
                ...
                if (ValoresRTO.Count() > 0)
                {
                    ...
                    {
                        long _valor = long.Parse(valor);
                        string _Descripcion = db.tblEscala.FirstOrDefault(x => x.IdEmpresa == IdEmpresa && x.IdTipoEscala == 4 && x.IdEscala == _valor).Descripcion;
                        tblCriticidad _criticidad = new tblCriticidad
                        {
                            DescripcionEscala = _Descripcion,
                            IdEmpresa = IdEmpresa,
                ...
                if (ValoresRPO.Count() > 0)
                {
                    ...
                    {
                        long _valor = long.Parse(valor);
                        string _Descripcion = db.tblEscala.FirstOrDefault(x => x.IdEmpresa == IdEmpresa && x.IdTipoEscala == 5 && x.IdEscala == _valor).Descripcion;
                        tblCriticidad _criticidad = new tblCriticidad
                        {
                            DescripcionEscala = _Descripcion,
                            IdEmpresa = IdEmpresa,
                ...
                if (ValoresWRT.Count() > 0)
                {
                    ...
                    {
                        long _valor = long.Parse(valor);
                        string _Descripcion = db.tblEscala.FirstOrDefault(x => x.IdEmpresa == IdEmpresa && x.IdTipoEscala == 6 && x.IdEscala == _valor).Descripcion;
                        tblCriticidad _criticidad = new tblCriticidad
                        {
                            DescripcionEscala = _Descripcion,
                            IdEmpresa = IdEmpresa,
