                ...
                using (Entities db = new Entities())
                {
                    ...
                    if (_DataEjecucion != null)
                    {
                        ...
                        foreach (tblPBEPruebaPlanificacionEjercicio registro in _DataEjecucion.tblPBEPruebaPlanificacion.tblPBEPruebaPlanificacionEjercicio)
                        {
                            ...
                            _Phrase = new Phrase(string.Format("{0} Horas", registro.Duracion.ToString()), _Font9Normal);
                            _Cell = new PdfPCell(_Phrase)
                            {
                                PaddingTop = 5,
                                PaddingBottom = 5,
                        ...
                        _parrafo = new Paragraph("HALAZGOS DE LA PRUEBA", _FontHeader1);
                        _parrafo.Alignment = Element.ALIGN_CENTER;
                        _Documento.Add(_parrafo);
                        _Documento.Add(new Paragraph(" "));
                        ...
                        _parrafo = new Paragraph("ACCIONES RESULTANTES DE LA PRUEBA", _FontHeader1);
                        _parrafo.Alignment = Element.ALIGN_CENTER;
                        _Documento.Add(_parrafo);
                        _Documento.Add(new Paragraph(" "));
                        ...
                        try
                        {
                            ...
                            if (_DataEjecucion.tblPBEPruebaEjecucionResultado != null && _DataEjecucion.tblPBEPruebaEjecucionResultado.FirstOrDefault(e => e.IdContenido == 2) != null)
                            {
