            ...
            try
            {
                ...
                using (Entities db = new Entities())
                {
                    ...
                    if (_DataEjecucion != null)
                    {
                        ...
                        string _docPassowrd = string.Format("BCMWEB.N.{0}", IdEmpresa.ToString("000"));
                        string _ownerPassowrd = string.Format("PTI.N.{0}.BCMWEB", IdEmpresa.ToString("000"));
                         ...
                         * Línea 1
                         * **************** */
                        _Phrase = new Phrase(Resources.IniciativaResource.NroIniciativa, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                        ...
                        _Phrase = new Phrase(Resources.IniciativaResource.Nombre, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                         ...
                         * Línea 2
                         * **************** */
                        _Phrase = new Phrase(Resources.IniciativaResource.Descripcion, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                         ...
                         * Línea 3
                         * **************** */
                        _Phrase = new Phrase(Resources.IniciativaResource.UnidadOrganizativa, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                        ...
                        _Phrase = new Phrase(Resources.IniciativaResource.Responsable, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                         ...
                         * Línea 4
                         * **************** */
                        _Phrase = new Phrase(Resources.IniciativaResource.FechaInicioEstimada, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                        ...
                        _Phrase = new Phrase(Resources.IniciativaResource.FechaCierreEstimada, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                         ...
                         * Línea 5
                         * **************** */
                        _Phrase = new Phrase(Resources.IniciativaResource.FechaInicioReal, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                        ...
                        _Phrase = new Phrase(Resources.IniciativaResource.FechaCierreReal, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                         ...
                         * Línea 6
                         * **************** */
                        _Phrase = new Phrase(Resources.IniciativaResource.PresupuestoEstimado, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                        ...
                        _Phrase = new Phrase(Resources.IniciativaResource.PresupuestoReal, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                         ...
                         * Línea 7
                         * **************** */
                        _Phrase = new Phrase(Resources.IniciativaResource.MontoAbonado, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                        ...
                        _Phrase = new Phrase(Resources.IniciativaResource.MontoPendiente, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                         ...
                         * Línea 8
                         * **************** */
                        _Phrase = new Phrase(Resources.IniciativaResource.Estatus, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                        ...
                        _Phrase = new Phrase(Resources.IniciativaResource.Urgente, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                         ...
                         * Línea 9
                         * **************** */
                        _Phrase = new Phrase(Resources.IniciativaResource.PorcentajeAvance, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                         ...
                         * Línea 10
                         * **************** */
                        _Phrase = new Phrase(Resources.IniciativaResource.HorasEstimadas, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                        ...
                        _Phrase = new Phrase(Resources.IniciativaResource.HorasInvertidas, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
                         ...
                         * Línea 11
                         * **************** */
                        _Phrase = new Phrase(Resources.IniciativaResource.Observacion, _Font9Normal);
                        _Cell = new PdfPCell(_Phrase)
                        {
                            HorizontalAlignment = Element.ALIGN_LEFT,
                            VerticalAlignment = Element.ALIGN_MIDDLE,
